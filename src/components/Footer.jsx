            ...
            <div className="container mx-auto px-2">
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_3fr_1fr] grid-rows-2 gap-8">
                    ...
                    <div className="flex flex-wrap gap-4 justify-center items-center">
                        {navigationLinks.map(({ path, label }) => (
                            <Link
                                key={path}
                                to={path}
                                className="relative hover:text-gray-600 font-acumin text-lg lg:text-[22px] lowercase first-letter:uppercase mx-2 transition-all duration-300 hover:-translate-y-0.5 after:content-[''] after:absolute after:w-0 after:h-0.5 after:bg-gray-600 after:left-0 after:-bottom-1 after:transition-all after:duration-300 hover:after:w-full"
                            >
                                {label}
                            </Link>
                        ))}
                        ...
                        <div className="relative">
                            <div className="flex justify-center lg:justify-end gap-4 relative py-2">
                                ...
                                <a
                                    ...
                                    className="text-black hover:text-gray-600 transition-all duration-300 hover:scale-110 hover:-translate-y-1"
                                >
                    ...
                    <div className="text-center">
                        <p className="text-sm lg:text-base text-gray-700 transition-opacity duration-300 hover:opacity-75">&copy; {new Date().getFullYear()} Online Marketing Creativo. Todos los derechos reservados.</p>
                    </div>
                </div>
            </div>
        </footer>
